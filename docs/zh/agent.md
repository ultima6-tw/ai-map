# AI 代理基礎 (Agent Foundations)

了解 AI 如何從單純的聊天機器人演進為具備工具使用與自主規劃能力的「代理」。

- **[大模型 AI 實踐指南：部署自己的 AI 助手 (OpenClaw)](https://www.youtube.com/watch?v=Vt-yMk3cie4)**
    - 從零開始部署 OpenClaw 的實踐指南，適合初學者快速上手。
- **[解剖小龍蝦 — 以 OpenClaw 為例介紹 AI Agent 的運作原理](https://youtu.be/2rcJdFuNbZQ?si=G-D7tPtyOctUkl43)**
